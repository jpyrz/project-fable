...
insert into public.recipes(id,output_item_id,reputation_required) values('sun-hat','item-16',1),('sunberry-tunic','item-121',2),('moon-crown','item-17',2),('star-wand','item-21',2) on conflict do nothing;
insert into public.recipe_ingredients(recipe_id,item_id,quantity) values('sun-hat','item-10',2),('sun-hat','item-14',1),('sunberry-tunic','item-11',2),('sunberry-tunic','item-14',1),('moon-crown','item-11',2),('moon-crown','item-13',1),('star-wand','item-10',1),('star-wand','item-13',2) on conflict do nothing;
